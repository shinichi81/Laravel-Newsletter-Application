                                    ...
                                    <div id="wizard-vertical">
                                        ...
                                        <section>
                                            ...
                                            <label>Enter Emails Manually </label>
                                                <textarea placeholder="manually enter emails seperated by commas. eg. name@email.com, anothername@email.com, anotheranothername@email.com" class="form-control"></textarea><br>
